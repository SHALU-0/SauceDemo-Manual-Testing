...
Open https://www.saucedemo.com/ in a supported browser
Follow the preconditions listed in each test case
Execute the steps and compare actual results to expected results
Log any discrepancies as bugs
---
