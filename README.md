...
- Cart Page: Navigation, product display, remove functionality, continue shopping button, empty cart behaviour, cart persistence on refresh
...
2. Follow the prerequisites listed in each test case.
